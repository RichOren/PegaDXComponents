  ...
  const bulkUpdateAllRows = () => {
   ...
   /* if(checkBoxSelectedState === 'on') {
    ...
    rowsToBeUpdated.forEach((row) => {
      ...
      console.log('embeddedRowToBeUpdated: ', embeddedRowToBeUpdated);
        ...
        <StyledBox>
            ...
            <DataGridPro
              ...
              onCellEditStop={(params: GridCellEditStopParams, event: MuiEvent) => {
                ...
                console.log('BunchOShit:::: ', activeSelectedRow, activeSelectedRowId, activeSelectedRowComment, indexOfRow);
